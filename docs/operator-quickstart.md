# Operator Quickstart — Event catering and other food service activities

Shortest path from clone to a verified local dry-run for **ISIC 562** (`cloud-itonami-isic-562`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-562.git
cd cloud-itonami-isic-562
```
...
- Likely source path: `cateringops.governor.cljc`
