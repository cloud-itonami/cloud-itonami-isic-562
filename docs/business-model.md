# Business Model: Event Catering and Other Food Service Activities - Operations Coordination
...
- ISIC Rev.5: `` — Event Catering and Other Food Service Activities - Operations Coordination
- Domain: `:services/catering-coordination`
- Social impact: :operational-efficiency :facility-safety :administrative-transparency
- Actor: `:cateringops-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :services/catering-coordination — who wants
...
One managed tenant (:services/catering-coordination):
...
- Do not bypass the `:cateringops-governor` for production decisions.
